...
class TripTableViewController: UITableViewController {
    ...
    func loadTravelogue() {
        ...
        do {
            ...
            createFailAlert(message: "Failed to load the data", error: error as! String, parent: self)
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = cell as? TripTableViewCell {
            if let date = travelogue[row].modifiedDate, let name = travelogue[row].name {
                ...
                cell.createdLabel.text = "Created: \(formatter.string(from: date))"
            }
        }
    ...
    func handleDelete(indexPath: IndexPath) {
        ...
        let alert = UIAlertController(title: "Are you sure you want to delete this trip?", message: "", preferredStyle: .alert)
